...
#define SUPER_FRUIT_COLOR CLITERAL{0, 102, 255,255}
#define SUPER_FRUIT_OUT_COLOR CLITERAL{0, 51, 204,255}
...
#define SPOT_SPEED 9 //for course mode
#define SPOT_SPEED_VARIATION 200 //factor /100 to keep in mind
...
#define SUPER_FRUIT_FREQUENCY 8 //the proportion of fruits that are super fruit (the higher the lower)
...
#define DASH_COLOR_VARIATION_SPEED 8
...
#define HURT_WIDTH_REDUCTION 7 //when a snake is hurt
