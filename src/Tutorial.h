...
static const char TUTO_TEXT[8][1000] = {"You are a planarian flatworm confined into a aquarium by scientists.\n \
...
"You hurt yourself if you run on your body : you width decreases \n \
...
Dash into the enemy to hurt it. Hurt it enough and it's split in two !\n\
I told you : epic regeneration abilities !\n \
To be more effective you can also make the enemy run into you.",
...
without dash, you're hurt. But the opposite is also true !\n\
Use this as a way to kill enemies !",
"Luckly for you, there is bits of  growing moisture to eat\n\
 in order to regenerate length and width",
